...
df_final = df_first_bet.merge(df_parsed[['id', 'score', 'current_time', 'hh_value', 'line_value']], on='id', how='inner', suffixes=('', '_current'))
...
df_tele = df_final[['id', 'cid', 'l', 'n', 'match_name', 'score', 'match_time',
       ...
       'score_current', 'current_time_current', 'hh_value', 'line_value'
       ]]
